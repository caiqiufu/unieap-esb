 ...
 *         &lt;element name="DeleteRechageBlackRequest" type="{http://www.huawei.com/bme/cbsinterface/cbs/businessmgr}DeleteRechageBlackRequest"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "DeleteRechageBlackRequestMsg", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgrmsg")
public class DeleteRechageBlackRequestMsg {

    @XmlElement(name = "RequestHeader", namespace = "", required = true)
    protected RequestHeader requestHeader;
    @XmlElement(name = "DeleteRechageBlackRequest", namespace = "", required = true)
