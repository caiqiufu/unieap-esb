 ...
 *         &lt;element name="NewSubscriberResult" type="{http://www.huawei.com/bme/cbsinterface/cbs/businessmgr}NewSubscriberResult"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "NewSubscriberResultMsg", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgrmsg")
public class NewSubscriberResultMsg {

    @XmlElement(name = "ResultHeader", namespace = "", required = true)
    protected ResultHeader resultHeader;
    @XmlElement(name = "NewSubscriberResult", namespace = "", required = true, nillable = true)
