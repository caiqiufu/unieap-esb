 ...
 *         &lt;element name="ChangeSIMRequest" type="{http://www.huawei.com/bme/cbsinterface/cbs/businessmgr}ChangeSIMRequest"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ChangeSIMRequestMsg", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgrmsg")
public class ChangeSIMRequestMsg {

    @XmlElement(name = "RequestHeader", namespace = "", required = true)
    protected RequestHeader requestHeader;
    @XmlElement(name = "ChangeSIMRequest", namespace = "", required = true)
