 ...
 *         &lt;element name="UnSubscribeAppendantProductRequest" type="{http://www.huawei.com/bme/cbsinterface/cbs/businessmgr}UnSubscribeAppendantProductRequest"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "UnSubscribeAppendantProductRequestMsg", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgrmsg")
public class UnSubscribeAppendantProductRequestMsg {

    @XmlElement(name = "RequestHeader", namespace = "", required = true)
    protected RequestHeader requestHeader;
    @XmlElement(name = "UnSubscribeAppendantProductRequest", namespace = "", required = true)
