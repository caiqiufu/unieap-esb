 ...
 *         &lt;element name="ChangeServicesRequest" type="{http://www.huawei.com/bme/cbsinterface/cbs/businessmgr}ChangeServicesRequest"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ChangeServicesRequestMsg", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgrmsg")
public class ChangeServicesRequestMsg {

    @XmlElement(name = "RequestHeader", namespace = "", required = true)
    protected RequestHeader requestHeader;
    @XmlElement(name = "ChangeServicesRequest", namespace = "", required = true)
