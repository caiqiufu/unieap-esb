 ...
 *         &lt;element name="ChangeCustBasicInforRequest" type="{http://www.huawei.com/bme/cbsinterface/cbs/businessmgr}ChangeCustBasicInforRequest"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ChangeCustBasicInforRequestMsg", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgrmsg")
public class ChangeCustBasicInforRequestMsg {

    @XmlElement(name = "RequestHeader", namespace = "", required = true)
    protected RequestHeader requestHeader;
    @XmlElement(name = "ChangeCustBasicInforRequest", namespace = "", required = true)
