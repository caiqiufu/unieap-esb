 ...
 *         &lt;element name="DeleteSubscriberRequest" type="{http://www.huawei.com/bme/cbsinterface/cbs/businessmgr}DeleteSubscriberRequest"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "DeleteSubscriberRequestMsg", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgrmsg")
public class DeleteSubscriberRequestMsg {

    @XmlElement(name = "RequestHeader", namespace = "", required = true)
    protected RequestHeader requestHeader;
    @XmlElement(name = "DeleteSubscriberRequest", namespace = "", required = true)
