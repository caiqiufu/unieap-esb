 ...
 *         &lt;element name="ChangeMSISDNRequest" type="{http://www.huawei.com/bme/cbsinterface/cbs/businessmgr}ChangeMSISDNRequest"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ChangeMSISDNRequestMsg", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgrmsg")
public class ChangeMSISDNRequestMsg {

    @XmlElement(name = "RequestHeader", namespace = "", required = true)
    protected RequestHeader requestHeader;
    @XmlElement(name = "ChangeMSISDNRequest", namespace = "", required = true)
