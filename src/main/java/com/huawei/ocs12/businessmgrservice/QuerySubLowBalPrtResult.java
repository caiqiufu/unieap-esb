...
public class QuerySubLowBalPrtResult {
    ...
    public static class SubLowBalPrt {
        ...
        @XmlElement(name = "CallLowBalType", required = true, type = Integer.class, nillable = true)
        protected Integer callLowBalType;
        @XmlElement(name = "BalanceUpGate", required = true, type = Integer.class, nillable = true)
        protected Integer balanceUpGate;
        @XmlElement(name = "BalanceLowGate", required = true, type = Integer.class, nillable = true)
