 ...
 *         &lt;element name="QuerySubscribedGroupResult" type="{http://www.huawei.com/bme/cbsinterface/cbs/businessmgr}QuerySubscribedGroupResult"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "QuerySubscribedGroupResultMsg", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgrmsg")
public class QuerySubscribedGroupResultMsg {

    @XmlElement(name = "ResultHeader", namespace = "", required = true)
    protected ResultHeader resultHeader;
    @XmlElement(name = "QuerySubscribedGroupResult", namespace = "", required = true)
