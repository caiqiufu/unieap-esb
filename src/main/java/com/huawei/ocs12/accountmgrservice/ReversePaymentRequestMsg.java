 ...
 *         &lt;element name="ReversePaymentRequest" type="{http://www.huawei.com/bme/cbsinterface/cbs/accountmgr}ReversePaymentRequest"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ReversePaymentRequestMsg", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/accountmgrmsg")
public class ReversePaymentRequestMsg {

    @XmlElement(name = "RequestHeader", namespace = "", required = true)
    protected RequestHeader requestHeader;
    @XmlElement(name = "ReversePaymentRequest", namespace = "", required = true)
