 ...
 *       &lt;sequence>
 *         &lt;element name="SimleProperty" type="{http://www.huawei.com/bme/cbsinterface/cbs/accountmgr}SimpleProperty" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class SimplePropertyList {
    ...
    @XmlElement(name = "SimleProperty", required = true)
