 ...
 *         &lt;element name="TransInPpsPosResult" type="{http://www.huawei.com/bme/cbsinterface/cbs/accountmgr}TransInPpsPosResult"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "TransInPpsPosResultMsg", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/accountmgrmsg")
public class TransInPpsPosResultMsg {

    @XmlElement(name = "ResultHeader", namespace = "", required = true)
    protected ResultHeader resultHeader;
    @XmlElement(name = "TransInPpsPosResult", namespace = "", required = true)
