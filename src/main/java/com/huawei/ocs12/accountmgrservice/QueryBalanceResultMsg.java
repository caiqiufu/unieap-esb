 ...
 *         &lt;element name="QueryBalanceResult" type="{http://www.huawei.com/bme/cbsinterface/cbs/accountmgr}QueryBalanceResult"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "QueryBalanceResultMsg", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/accountmgrmsg")
public class QueryBalanceResultMsg {

    @XmlElement(name = "ResultHeader", namespace = "", required = true)
    protected ResultHeader resultHeader;
    @XmlElement(name = "QueryBalanceResult", namespace = "", required = true, nillable = true)
