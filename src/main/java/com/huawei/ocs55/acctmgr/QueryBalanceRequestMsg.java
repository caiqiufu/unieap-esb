 ...
 *         &lt;element name="QueryBalanceRequest" type="{http://www.huawei.com/bme/cbsinterface/cbs/accountmgr}QueryBalanceRequest"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "QueryBalanceRequestMsg", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/accountmgrmsg")
public class QueryBalanceRequestMsg {

    @XmlElement(name = "RequestHeader", namespace = "", required = true)
    protected RequestHeader requestHeader;
    @XmlElement(name = "QueryBalanceRequest", namespace = "", required = true)
