 ...
 *         &lt;element name="VoucherRechargeEnquiryRequest" type="{http://www.huawei.com/bme/cbsinterface/cbs/accountmgr}VoucherRechargeEnquiryRequest"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "VoucherRechargeEnquiryRequestMsg", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/accountmgrmsg")
public class VoucherRechargeEnquiryRequestMsg {

    @XmlElement(name = "RequestHeader", namespace = "", required = true)
    protected RequestHeader requestHeader;
    @XmlElement(name = "VoucherRechargeEnquiryRequest", namespace = "", required = true)
