...
@XmlType(name = "QueryAdjustValidityLogResult", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr", propOrder = {
    "adjustValidityLog"
})
public class QueryAdjustValidityLogResult {
    ...
    public static class AdjustValidityLog {
        ...
        @XmlElement(name = "OperatorID", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr")
        ...
        @XmlElement(name = "OldSuspendStop", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr", required = true)
        protected String oldSuspendStop;
        @XmlElement(name = "NewSuspendStop", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr", required = true)
        protected String newSuspendStop;
        @XmlElement(name = "OldDisableStop", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr", required = true)
        protected String oldDisableStop;
        @XmlElement(name = "NewDisableStop", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr", required = true)
