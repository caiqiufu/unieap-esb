...
@XmlType(name = "Service", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr", propOrder = {
    "id",
    "status",
    "registrationTime",
    "simpleProperty"
...
@XmlSeeAlso({
    com.huawei.ocs55.businessmgr.BatchOperationRequest.BatchChangeService.Service.class,
    com.huawei.ocs55.businessmgr.ChangeServicesRequest.Service.class
})
