...
@XmlType(name = "ChangeSubLowBalPrtRequest", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr", propOrder = {
    "subscriberNo",
    "lowBalPrt"
})
public class ChangeSubLowBalPrtRequest {
    ...
    public static class LowBalPrt {
        ...
        @XmlElement(name = "CallLowBalType", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr")
        protected int callLowBalType;
        @XmlElement(name = "BalanceUpGate", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr")
        protected int balanceUpGate;
        @XmlElement(name = "BalanceLowGate", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr")
        protected int balanceLowGate;
        @XmlElement(name = "Action", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr")
        protected Integer action;
        @XmlElement(name = "MessageID", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr")
