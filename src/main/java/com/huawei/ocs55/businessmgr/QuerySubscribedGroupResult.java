...
@XmlType(name = "QuerySubscribedGroupResult", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr", propOrder = {
    "userGroup"
})
public class QuerySubscribedGroupResult {
    ...
    public static class UserGroup {
        ...
        @XmlElement(name = "GroupID", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr", required = true, nillable = true)
