...
@XmlType(name = "Account", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr", propOrder = {
    "name",
    "code",
    "address",
    "title",
...
@XmlSeeAlso({
    com.huawei.ocs55.businessmgr.QueryBasicInfoResult.SubscriberAccount.class,
    com.huawei.ocs55.businessmgr.QueryBasicInfoResult.Account.class
})
