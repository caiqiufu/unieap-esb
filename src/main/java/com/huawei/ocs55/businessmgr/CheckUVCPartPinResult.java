...
@XmlType(name = "CheckUVCPartPinResult", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr", propOrder = {
    "cardInfo"
})
public class CheckUVCPartPinResult {
    ...
    public static class CardInfo {
        ...
        @XmlElement(name = "CardPartPin", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr", required = true)
        protected String cardPartPin;
        @XmlElement(name = "HotFlag", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr", required = true)
