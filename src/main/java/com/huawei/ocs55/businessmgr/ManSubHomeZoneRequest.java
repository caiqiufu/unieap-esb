...
@XmlType(name = "ManSubHomeZoneRequest", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr", propOrder = {
    "subscriberNo",
    "homeZoneInfo",
    "operationType",
    "handlingChargeFlag"
...
public class ManSubHomeZoneRequest {
    ...
    public static class HomeZoneInfo {
        ...
        @XmlElement(name = "HomeZoneID", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr", required = true)
        protected String homeZoneID;
        @XmlElement(namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr")
        protected String effectiveDate;
        @XmlElement(namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr")
        protected String expireDate;
        @XmlElement(name = "NewHomeZoneID", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr")
