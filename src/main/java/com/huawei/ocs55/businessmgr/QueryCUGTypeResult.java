...
@XmlType(name = "QueryCUGTypeResult", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr", propOrder = {
    "cugTypeList"
})
public class QueryCUGTypeResult {
    ...
    public static class CUGTypeList {
        ...
        @XmlElement(name = "CUGType", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr", required = true)
        protected BigInteger cugType;
        @XmlElement(name = "CUGTypeName", namespace = "http://www.huawei.com/bme/cbsinterface/cbs/businessmgr", required = true)
