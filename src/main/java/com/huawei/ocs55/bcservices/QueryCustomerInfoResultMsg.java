...
@XmlRootElement(name = "QueryCustomerInfoResultMsg", namespace = "http://www.huawei.com/bme/cbsinterface/bcservices")
public class QueryCustomerInfoResultMsg {

    @XmlElement(name = "ResultHeader", namespace = "", required = true)
    protected ResultHeader resultHeader;
    @XmlElement(name = "QueryCustomerInfoResult", namespace = "", required = true)
