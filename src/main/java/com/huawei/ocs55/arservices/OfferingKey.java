...
@XmlSeeAlso({
    com.huawei.ocs55.arservices.QueryOCSBalanceResult.FreeUnitItem.FreeUnitItemDetail.FreeUnitOrigin.OfferingKey.class
})
public class OfferingKey {

    @XmlElementRef(name = "OfferingID", namespace = "http://cbs.huawei.com/ar/wsservice/arcommon", type = JAXBElement.class, required = false)
